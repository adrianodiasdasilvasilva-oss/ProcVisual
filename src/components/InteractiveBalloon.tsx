  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="relative bg-proc-secondary/40 backdrop-blur-2xl border border-white/10 rounded-3xl p-5 shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden group">
            {/* Background Glow */}
            ...
            <div className="flex gap-4 relative z-10">
              <div className="shrink-0 w-10 h-10 rounded-2xl bg-white/5 flex items-center justify-center border border-white/5">
                {currentMessage.icon}
              </div>
              ...
              <button 
                ...
                className="shrink-0 p-1 text-proc-text-sec hover:text-white transition-colors"
              >
                <X size={14} />
              </button>
            </div>
